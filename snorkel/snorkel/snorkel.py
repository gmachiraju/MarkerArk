...
sys.path.append(os.path.join(os.getcwd(), 'treedlib'))
sys.path.append(os.path.join(os.getcwd(), 'snorkel'))

from treedlib.treedlib import *
from treedlib import *

sys.path.append('/Users/cameronbaab/Documents/Marker-Reader4/snorkel')
