import BiomarkerMatcher, BiomarkerTypeMatcher
...
def generateRelations(_filename):
    ...
    pckl_f = "cache/" + _filename + "/" + 'sentences.pkl'
    # try:
    ...
    possiblePairs = Relations(sentences, CandidateExtractor_BM, CandidateExtractor_TM)
