...
class Article():
 ...
 def num_mentions_scorer(self, disease, biomarker, article_list):
  #Obtain a list of articles that has the disease and biomarker in it
  #Pretend that this list has been populated and is now stored in the variable "article_list". This list is populated by Article objects
  #The article that I am scoring will be called curr_article (format is Article object)
  curr_article = self
  #For the sake of writing an algorithm, pretend that curr_article is actually a thing
  ...
  #Now divide the position by the number of elements for our score. This score is out of 100
 ...
 def articleScorer(self,filename, biomarkerName, diseaseName, article_list):
  ...
  #mentions:
  mentionsScore = 25 * self.num_mentions_scorer(disease=diseaseName, biomarker=biomarkerName, article_list=article_list)
  # relationsRat:
